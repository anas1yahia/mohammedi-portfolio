...
export class WorkStepsComponent {
  steps = [
    {
      title: 'تواصل معي',
      description: 'أرسل لي تفاصيل مشروعك أو فكرتك عبر البريد الإلكتروني أو الواتساب.',
      color: '#a2d9ce', // Soft Turquoise
      stepNumber: '01',
      iconPath: 'M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z'
    },
    {
      title: 'إرسال الملخص',
      description: 'سنناقش التفاصيل والمتطلبات والميزانية لتحديد نطاق العمل بوضوح.',
      color: '#f7dc6f', // Warm Sand/Gold
      stepNumber: '02',
      iconPath: 'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2v6h6 M16 13H8 M16 17H8 M10 9H8'
    },
    {
      title: 'بدء العمل',
      description: 'بعد الاتفاق، سأبدأ في تنفيذ المشروع وتسليم النماذج الأولية للمراجعة.',
      color: '#aed6f1', // Calm Blue
      stepNumber: '03',
