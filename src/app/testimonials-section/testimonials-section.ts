...
export class TestimonialsSectionComponent {
  ...
  testimonials = [
    ...
    {
      content: `محمد الأمين محمدي خلوق ومحترم ومريح في التعامل على الصعيد الشخصي ويتلقى الملاحظات بصدر رحب، وعلى المهارات التقنية فهو متمكن من الأدوات التي يستخدمها ويقدم النصح والإرشاد لاستخدام أفضل الأدوات`,
